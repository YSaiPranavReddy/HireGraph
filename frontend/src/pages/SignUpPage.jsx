    ...
    <div className="auth-page">
      ...
      <div className="auth-container">
        ...
        <div className="auth-links">
          <div>Already have an account? <Link to="/sign-in" className="auth-link">Sign in</Link></div>
        </div>

        <div className="auth-footer-badge">
          This site is protected by hCaptcha. Its <a href="#">Privacy Policy</a> and <a href="#">Terms of Service</a> apply.
        </div>
      </div>
    </div>
  );
