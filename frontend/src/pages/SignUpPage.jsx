    ...
    <div className="auth-page">
      ...
      <div className="auth-split-layout">
         <div className="auth-left-floating">
          ...
          <p className="auth-welcome-subtitle">Hire smarter, not harder.<br />Create your account to get started.</p>
        </div>
        
        <div className="auth-right-card">
          <div className="auth-form-wrapper">
            <Link to="/sign-in" className="auth-custom-link">&lt; Back to Login</Link>
            <SignUp
              routing="path"
              path="/sign-up"
              signInUrl="/sign-in"
              ...
              appearance={{
                ...
                variables: {
                  colorPrimary: '#61f2a3', // Bloom green flavor
