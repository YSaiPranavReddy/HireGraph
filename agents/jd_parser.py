...
#   "dealbreaker_skills": ["skill that is explicitly must-have or eliminates candidate if missing"],
...
# Rules:
# - dealbreaker_skills: only populate if the JD uses words like "must", "required", "essential", "mandatory"
# - skill_categories: re-categorize required_skills into subcategories for precision matching against resumes
# - education_is_strict: true ONLY if JD explicitly says "degree required" with no "or equivalent"
